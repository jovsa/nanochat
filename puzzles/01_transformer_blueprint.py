...
Usage:
python puzzles/01_transformer_blueprint.py          # Run the puzzle
python puzzles/01_transformer_blueprint.py --verify # Verify your solution
python puzzles/01_transformer_blueprint.py --peek   # See reference solution (oracle)
"""
...
class ModelSetup:
    ...
    def __init__(self, depth: int, sequence_len: int = 2048, window_pattern: str = "SSSL"):
        ...
        self.n_head = None  # TODO
        self.n_kv_head = None  # TODO
        self.n_embd = None  # TODO
        self.vocab_size = 32768
        
        raise NotImplementedError("Implement the config derivation from depth")
    ...
    def compute_rotary_embeddings(self, device="cpu") -> tuple[torch.Tensor, torch.Tensor]:
        ...
        """
        # YOUR CODE HERE
        raise NotImplementedError("Implement rotary embeddings computation")
